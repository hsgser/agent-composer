"""`shape_to_schema` — derive a pydantic model from a declared output `Type`."""
...
def test_list_of_records():
    ...
    shape = Type(kind=ValueKind.LIST_OBJECT, element=elem)
    model = shape_to_schema(shape)
